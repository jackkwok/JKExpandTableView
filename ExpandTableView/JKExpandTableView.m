...
- (void)configureCell:(UITableViewCell *)tableCell withParentIndex:(NSInteger)parentIndex {
	
	if ([tableCell isKindOfClass: [JKSubTableViewCell class]] ){
		JKSubTableViewCell *cell = (JKSubTableViewCell*) tableCell;
		...
		JKParentTableViewCell *cell = (JKParentTableViewCell*) tableCell;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (isExpansionCell) {
		...
		JKSubTableViewCell * cell;
		
		if (isMultiSelect) {
			cell = (JKMultiSelectSubTableViewCell *)[self dequeueReusableCellWithIdentifier:CellIdentifier_MultiSelect];
			if (cell == nil) {
			...
			cell = (JKSingleSelectSubTableViewCell *)[self dequeueReusableCellWithIdentifier:CellIdentifier_SingleSelect];
			if (cell == nil) {
